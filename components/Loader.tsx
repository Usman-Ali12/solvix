// Pure CSS-driven loader — no hooks, no client-side timers. The show/hide
// timing lives entirely in globals.css (`.loader` animation), so this can
// never get stuck waiting on React state or hydration to finish.
